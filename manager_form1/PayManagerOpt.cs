...
namespace manager_form1
{
    public partial class PayManagerOpt : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Reference no not found", "Payment Process Failed", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
            con.Close();
        }
        Boolean flag;
        ...
        private void PayManagerOpt_Load(object sender, EventArgs e)
        {
            textBox5.Text = UserControl2.SetValueForText1;
        }
